...
namespace iLgs.Services.CustodianReports
{
    public interface ICustodianReportItemVehicleService : ICustodianReportItemService
    {
        ...
        IQueryable<CustodianReportItemVehicleVM> GetAll(Guid? reportId);
        IQueryable<CustodianReportItemVehicleVM> GetAllByDeptAcctGroup(Guid? deptId, int? accountGroup);
    ...
    public class CustodianReportItemVehicleService : CustodianReportItemService, ICustodianReportItemVehicleService
    {
        ...
        _exceptionService.TryCatch(async () =>
        {
            var data = await _db.CustodianReportItems
                .Where(w => w.Id == id)
                .Select(s => new CustodianReportItemVehicleVM
                {
                    Id = s.Id,
        ...
        public IQueryable<CustodianReportItemVehicleVM> GetAll(Guid? reportId)
        {
        ...
        public IQueryable<CustodianReportItemVehicleVM> GetAllByDeptAcctGroup(Guid? deptId, int? accountGroup)
        {
            var data = _db.CustodianReportItems
                .AsNoTracking()
