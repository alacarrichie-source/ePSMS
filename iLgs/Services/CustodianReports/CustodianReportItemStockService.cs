    ...
    public class CustodianReportItemStockService : CustodianReportItemService, ICustodianReportItemStockService
    {
        ...
        _exceptionService.TryCatch(async () =>
        {
            var data = await _db.CustodianReportItems
                .Where(w => w.Id == id)
                .Select(s => new CustodianReportItemStockVM
                {
                    Id = s.Id,
        ...
        private CustodianReportItemStockVM GetCustodianReportItemStockVM(CustodianReportItem s)
        {
            return new CustodianReportItemStockVM()
            {
                Id = s.Id,
                ReportId = s.ReportId,
                Fund = s.Fund,
