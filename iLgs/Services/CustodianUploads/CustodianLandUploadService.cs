...
{
    public interface ICustodianLandUploadService : IUploadService
    {
    }
    ...
    public class CustodianLandUploadService : UploadService, ICustodianLandUploadService
    {
        ...
        {
            var result = await _db.CustodianReportLandItems.Where(w => w.Id == imageId).AnyAsync(a => a.PostedBy != "" && a.PostedBy != null);
            return result;
        }
