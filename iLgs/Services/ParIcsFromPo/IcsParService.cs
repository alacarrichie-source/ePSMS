...
namespace iLgs.Services.ParIcsFromPo
{
    public interface IIcsParService : IIcsParSharedService
    {
        ...
        //IQueryable<IcsPar> GetAllPars(Guid? unitGroupId, Guid? psCardItemId);
        //IQueryable<IcsPar> GetAllIcs(Guid? unitGroupId, Guid? psCardItemId);
        IQueryable<IcsPar> GetAllPars(Guid? psCardItemId);
        IQueryable<IcsPar> GetAllIcs(Guid? psCardItemId);
    ...
    public class IcsParService : BaseValidator, IIcsParService
    {
        ...
        //public IQueryable<IcsPar> GetAllIcs(Guid? unitGroupId, Guid? psCardItemId)
        //{
        //    return GetAllIcsPars(unitGroupId,  psCardItemId, "I");
        //}

        //public IQueryable<IcsPar> GetAllPars(Guid? unitGroupId, Guid? psCardItemId)
        //{
        //    return GetAllIcsPars(unitGroupId, psCardItemId, "P");
        //}

        //private IQueryable<IcsPar> GetAllIcsPars(Guid? unitGroupId, Guid? psCardItemId, string refType)
        //{
        //    var data = _db.IcsPars.Where(w => w.RefType == refType).AsNoTracking().AsQueryable();
        //    if (unitGroupId != null)
        //    {
        //        data = data.Where(w => w.IcsParItems.Any(a => a.PsCardItemExtn.PsCardItem.PsCardItemUnitGroupDescriptionItems.FirstOrDefault().PsCardItemUnitGroupDescription.UnitGroupId == unitGroupId));
        //    }
        //    else
        //    {
        //        data = data.Where(w => w.IcsParItems.Any(a => a.PsCardItemExtn.PsCardItem.Id == psCardItemId));
        //    }
        //    return data;
        //}

        public IQueryable<IcsPar> GetAllIcs(Guid? psCardItemId)
        {
            return GetAllIcsPars(psCardItemId, "I");
        }

        public IQueryable<IcsPar> GetAllPars(Guid? psCardItemId)
        {
            return GetAllIcsPars(psCardItemId, "P");
        }

        private IQueryable<IcsPar> GetAllIcsPars(Guid? psCardItemId, string refType)
        {
            var data = _db.IcsPars.Where(w => w.RefType == refType).AsNoTracking().AsQueryable();            
                data = data.Where(w => w.IcsParItems.Any(a => a.PsCardItemExtn.PsCardItem.Id == psCardItemId));
