...
namespace iLgs.Controllers
{
    ...
    public class RISController : BaseController
    {
        ...
        //    _risService.RisItem = risItemService;
        //    _risService.UnitGroup = risItemUnitGroupService;
        //    _risService.UnitGroup.UnitGroupDescription = risItemUnitGroupDescriptionService;
        //    _risService.UnitGroup.UnitGroupDescription.UnitGroupDescriptionItem = risItemUnitGroupDescriptionItemService;
        ...
        //        var entity = await _risService.RisItem.GetByIdAsync(model.Id);
        //        if (entity == null)
        //        {
        //            if (!access.AllowAdd)
        //            {
        ...
        //            if (entity == null)
        //            {
        //                model = await _risService.RisItem.CreateAsync(model, user, date);
        //            }
        //            else
        //            {
        //                model = await _risService.RisItem.UpdateAsync(model, user, date);
        //            }
        //        }
        //    }
        //    catch (ValidationException validationException) when (validationException.InnerException is InvalidModelException)
        ...
        //            model = await _risService.RisItem.DeleteAsync(model, user, date);
        //        }
        //    }
        //    catch (ValidationException validationException)
        //    {
        ...
        //            model = await _risService.UnitGroup.CreateAsync(model, user, date);
        //        }
        //    }
        //    catch (ValidationException validationException) when (validationException.InnerException is InvalidModelException)
        //    {
        ...
        //            model = await _risService.UnitGroup.UpdateAsync(model, user, date);
        //        }
        //    }
        //    catch (ValidationException validationException) when (validationException.InnerException is InvalidModelException)
        //    {
        ...
        //            model = await _risService.UnitGroup.DeleteAsync(model, user, date);
        //        }
        //    }
        //    catch (ValidationException validationException)
        //    {
        ...
        //            model = await _risService.UnitGroup.UnitGroupDescription.CreateAsync(model, user, date);
        //        }
        //    }
        //    catch (ValidationException validationException) when (validationException.InnerException is InvalidModelException)
        //    {
        ...
        //            model = await _risService.UnitGroup.UnitGroupDescription.UpdateAsync(model, user, date);
        //        }
        //    }
        //    catch (ValidationException validationException) when (validationException.InnerException is InvalidModelException)
        //    {
        ...
        //            model = await _risService.UnitGroup.UnitGroupDescription.DeleteAsync(model, user, date);
        //        }
        //    }
        //    catch (ValidationException validationException)
        //    {
        ...
        //            model = await _risService.UnitGroup.UnitGroupDescription.UnitGroupDescriptionItem.CreateAsync(model, user, date);
        //        }
        //    }
        //    catch (ValidationException validationException) when (validationException.InnerException is InvalidModelException)
        //    {
        ...
        //            model = await _risService.UnitGroup.UnitGroupDescription.UnitGroupDescriptionItem.UpdateAsync(model, user, date);
        //        }
        //    }
        //    catch (ValidationException validationException) when (validationException.InnerException is InvalidModelException)
        //    {
        ...
        //            model = await _risService.UnitGroup.UnitGroupDescription.UnitGroupDescriptionItem.DeleteAsync(model, user, date);
        //        }
        //    }
        //    catch (ValidationException validationException)
        //    {
        ...
        public async Task<ActionResult> RisDepartmentRpt(RisPrintVM model)
        {
            try
            {
            ...
            rpt.FileName = Server.MapPath(Url.Content("~/Reports/RisDepartment.rpt"));
            rpt.Refresh();
