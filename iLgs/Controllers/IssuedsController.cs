            ...
            try
            {
                ...
                else
                {
                    model = await db.Issueds.Where(w => w.SerialNo == serialNo).Select(s => new IssuedVM
                    {
                        Id = s.Id,
                        OrderId = s.OrderId,
                        SerialYear = s.SerialYear,
                        SerialMonth = s.SerialMonth,
                        SerialSeries = s.SerialSeries,
                        SerialNo = s.SerialNo,
                        Date = s.Date,
                        Fund = s.Fund,
                        CertifiedBy = s.CertifiedBy,
                ...
                if (model != null && ModelState.IsValid)
                {
                    ...
                    if (entity == null)
                    {
                        ...
                        entity = new Issued()
                        {
                            ...
                            SerialYear = model.SerialYear,
                            SerialMonth = model.SerialMonth,
                            SerialSeries = model.SerialNo.Split('-')[2],
                            SerialNo = model.SerialNo,
                            Date = model.Date,
                            Fund = model.Fund,
                            CertifiedBy = model.CertifiedBy,
                            CertifiedDt = model.CertifiedDt,
