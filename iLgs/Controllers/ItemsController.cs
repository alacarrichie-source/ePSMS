...
namespace iLgs.Controllers
{
    ...
    public class ItemsController : Controller
    {
        ...
        public JsonResult GetItems(string text)
        {
            ...
            return Json(model.Select(c => new { Id = c.Id, Code = c.Code, Description = c.Description, Type = c.ItemType, TypeDesc = c.ItemTypeDesc, ItemNo = c.ItemNo, MainDesc = c.MainDesc, Account = c.Account, SubArticle = c.SubArticle }), JsonRequestBehavior.AllowGet);
        }
