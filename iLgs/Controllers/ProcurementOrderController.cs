...
//using iLgs.Services.Procurement_;
...
//{
//    [AppAuthorize("PROCUREMENTORDER")]
//    public class ProcurementOrderController : BaseController
//    {
//        //private readonly AppManEntities _db;
//        private readonly IProcurementOrderService _orderService;
...
//        public ProcurementOrderController(AppManEntities db,
//            IProcurementOrderService orderService,
...
//            _uploadPoService = orderUploadService.Create("procurement_order");
...
//        public async Task<ActionResult> Create([DataSourceRequest] DataSourceRequest request, ProcurementOrderVM model)
//        {
//            try
//            {
//                Task<Access> accessTask = Access(User.Identity.GetUserId(), "procurement_order");
...
//        [AcceptVerbs(HttpVerbs.Post)]
//        public async Task<ActionResult> OrderUpdate([DataSourceRequest] DataSourceRequest request, ProcurementOrderVM model)
//        {
//            try
//            {
//                Task<Access> accessTask = Access(User.Identity.GetUserId(), "procurement_order");
...
//        [AcceptVerbs(HttpVerbs.Post)]
//        public async Task<ActionResult> OrderDestroy([DataSourceRequest]DataSourceRequest request, ProcurementOrderVM model)
//        {
//            try
//            {
//                Task<Access> accessTask = Access(User.Identity.GetUserId(), "procurement_order");
