...
namespace iLgs.Reports {
    ...
    public class RpcPpeRegistry : ReportClass {
        
        public RpcPpeRegistry() {
        }
        
        public override string ResourceName {
            get {
                return "RpcPpeRegistry.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "iLgs.Reports.RpcPpeRegistry.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRpcPpeRegistry : Component, ICachedReport {
        
        public CachedRpcPpeRegistry() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RpcPpeRegistry rpt = new RpcPpeRegistry();
            rpt.Site = this.Site;
            return rpt;
        }
